    ...
    for (CSpace::TMapPerType::iterator it = tEpuckMap.begin(); it != tEpuckMap.end(); ++it) {
        ...
        {  
            ...
            if(tam1==0){
                ...
                MyFile<<robot<<";"<<"TA_enter"<<";"<<time_S<<std::endl;
                tam1=1;
            }
            timer1+=1;
        ...
        {  
            ...
            if(tam2==0){
                ...
                MyFile<<robot<<";"<<"TB_enter"<<";"<<time_S<<std::endl;
                tam2=1;
                }
            timer2+=1;
        ...
        if ((actionT1=="TA_task2" or actionT2=="TB_task2") and tam1==3 and tam2==3){
                timer12+=1;
        ...
        {  
            ...
            if(tam3==0){
                ...
                MyFile<<robot<<";"<<"TC_enter"<<";"<<time_S<<std::endl;
                tam3=1;
                }
            timer3+=1;
    ...
    //tam4
        ...
        {  
            ...
            if(tam4==0){
                ...
                MyFile<<robot<<";"<<"TD_enter"<<";"<<time_S<<std::endl;
                tam4=1;
                }
            timer4+=1;
        ...
        if ((actionT3=="TC_task2" or actionT4=="TD_task2") and tam3==3 and tam4==3){
                timer9+=1;
        ...
        {  
            ...
            if(tam5==0){
                ...
                MyFile<<robot<<";"<<"TE_enter"<<";"<<time_S<<std::endl;
                tam5=1;
                }
            timer5+=1;
        ...
        {  
            ...
            if(tam6==0){
                ...
                MyFile<<robot<<";"<<"TF_enter"<<";"<<time_S<<std::endl;
                tam6=1;
                }
            timer6+=1;
        ...
        if ((actionT5=="TE_task2" or actionT6=="TF_task2") and tam5==3 and tam6==3){
                timer10+=1;
        ...
        {  
            ...
            if(tam7==0){
                ...
                MyFile<<robot<<";"<<"TG_enter"<<";"<<time_S<<std::endl;
                tam7=1;
                }
            timer7+=1;
        ...
        {  
            ...
            if(tam8==0){
                ...
                MyFile<<robot<<";"<<"TH_enter"<<";"<<time_S<<std::endl;
                tam8=1;
                }
            timer8+=1;
        ...
        if ((actionT7=="TG_task2" or actionT8=="TH_task2") and tam7==3 and tam8==3){
                timer11+=1;
        ...
        if (actionT7=="TG_task3" and tam7==3 and tam8==3){
                    timer13+=1;
                    if (timer13==10){
                        tam7=4;
                        tam8=4;
...
Real TuttiTmLoopFunction::GetTamControl_Sec() {
CSpace::TMapPerType& tEpuckMap = GetSpace().GetEntitiesByType("epuck");
CVector2 cEpuckPosition(0,0);
Real y_l=0.1,x_l=0.10, rob=0, lim=0.000005;
    ...
    //tam4
        ...
        if (tam8==2){
            timer9+=1;
            if (timer9==100){
            MyFile<<robot<<";"<<"T1-TH_task9"<<";"<<time_S<<std::endl;
...
Real TuttiTmLoopFunction::GetTamControl_Par() {
CSpace::TMapPerType& tEpuckMap = GetSpace().GetEntitiesByType("epuck");
CVector2 cEpuckPosition(0,0);
Real y_l=0.1,x_l=0.10, rob=0, lim=0.000005;
...
/**Secuencial*/
void TuttiTmLoopFunction::InitBoxStates_Par() {
        GetTamControl_Par();
...
void TuttiTmLoopFunction::InitBoxStates_Sec() {
        GetTamControl_Sec();
