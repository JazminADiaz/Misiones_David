...
def time_format(file_path, cont,choice):
        ...
        #change the seconds acording to the number of the repetition of the mision to have a difference on the time

        log['time'] = time_log
        log['time'] = pd.to_datetime(log['time'], format='%Y-%m-%d %H:%M:%S')
        #change the case_id acording to the number of the repetition of the mision
        log['case_id']=case_id
